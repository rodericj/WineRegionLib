...
public struct OldItaly {
    ...
    public enum romagna: String, AppelationDescribable, CaseIterable  {
        case todo

    }
    public enum afriuliVeneziaGiuliany: String, AppelationDescribable, CaseIterable  {
        case todo

    }
    public enum friuliVeneziaGiuliaVeneto: String, AppelationDescribable, CaseIterable  {
        case todo
    ...
    public enum LazioUmbria: String, AppelationDescribable, CaseIterable  {
        case todo
    ...
    public enum LiguriaTuscany: String, AppelationDescribable, CaseIterable  {
        case todo
    ...
    public enum LombardyVeneto: String, AppelationDescribable, CaseIterable  {
    ...
    public enum TrentinoVneto: String, AppelationDescribable, CaseIterable  {
        case todo
